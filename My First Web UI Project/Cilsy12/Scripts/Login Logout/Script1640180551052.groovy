...
WebUI.click(findTestObject('Object Repository/Page_Kursus Online Server dan Jaringan  Cilsy.id/li_Fanny Restu Anindi Pengaturan AkunRiwaya_78df40'))

WebUI.click(findTestObject('Object Repository/Page_Kursus Online Server dan Jaringan  Cilsy.id/a_Logout'))
